...
This project is a simple demonstration of how you can set up an Angular + openapi-generator-cli.

> ⚠️ Don't forget to check out the [Back End](../backend/README.md) coupled to this project first.
